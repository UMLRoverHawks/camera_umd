...
public:
  ...
  Cam(const char *device, mode_t _mode = MODE_RGB,
      int _width = 640, int _height = 480, int _fps = 30, int _brightness = 128, int _contrast = 32, int _wbt = 5984, int _wbtauto = 1, int _plf = 2, int _gain = 200, int _sharpness = 224, int _backlight = 1, int _focusauto  = 1, int focus = 16, int _saturation = 32, int _pan = 0, int _tilt = 0, int _zoom = 1, int _expabs = 250, int _expauto = 1, int _expautop = 1);
  ~Cam();
